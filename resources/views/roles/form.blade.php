<div class="row">
    <div class="col-md-6 mb-3">
        <label for="code">{{ __('roles.code') }}</label>
        @if ($action == 'show')
            <input type="text" class="form-control-plaintext" id="code" name="code" :value="role.code" :readonly="true">
        @elseif ($action == 'edit')
    ...
    <div class="col-md-6 mb-3">
        ...
        @if ($action == 'show')
            <input type="text" class="form-control-plaintext" id="name" name="name" :value="role.name" :readonly="true">
        @elseif ($action == 'edit')
