<div class="row">
    <div class="col-md-6 mb-3">
        <label for="code">{{ __('provinces.code') }}</label>
        @if ($action == 'show')
            <input type="text" class="form-control-plaintext" id="code" name="code" :value="province.code" :readonly="true">
        @elseif ($action == 'edit')
    ...
    <div class="col-md-6 mb-3">
        <label for="name">{{ __('provinces.name') }}</label>
        @if ($action == 'show')
            <input type="text" class="form-control-plaintext" id="name" name="name" :value="province.name" :readonly="true">
        @elseif ($action == 'edit')
