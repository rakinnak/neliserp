<div class="row">
    <div class="col-md-6 mb-3">
        <label for="code">{{ __('cities.code') }}</label>
        @if ($action == 'show')
            <input type="text" class="form-control-plaintext" id="code" name="code" :value="city.code" :readonly="true">
        @elseif ($action == 'edit')
    ...
    <div class="col-md-6 mb-3">
        <label for="name">{{ __('cities.name') }}</label>
        @if ($action == 'show')
            <input type="text" class="form-control-plaintext" id="name" name="name" :value="city.name" :readonly="true">
        @elseif ($action == 'edit')
