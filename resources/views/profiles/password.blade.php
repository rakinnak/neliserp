...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <hr>
        <profile-password-edit inline-template>
            <form method="PATCH" action="#" @submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" class="form-control" :class="{'is-invalid': form.errors.has('old_password')}" id="old_password" name="old_password" value="" v-model="form.old_password">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" class="form-control" :class="{'is-invalid': form.errors.has('password')}" id="password" name="password" value="" v-model="form.password">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" class="form-control" :class="{'is-invalid': form.errors.has('password_confirmation')}" id="password_confirmation" name="password_confirmation" value="" v-model="form.password_confirmation">
